...
public class Endgame extends JPanel implements ActionListener, KeyListener {
    ...
    public Endgame() {
        ...
        // Load images
        background = new ImageIcon(Objects.requireNonNull(getClass().getResource("../resources/ultron.png"))).getImage();
        Image heroImage = new ImageIcon(Objects.requireNonNull(getClass().getResource("../resources/iron.png"))).getImage();
        Image heroOnClick = new ImageIcon(Objects.requireNonNull(getClass().getResource("../resources/thorClick.gif"))).getImage();
        upperEnemyImage = new ImageIcon(Objects.requireNonNull(getClass().getResource("../resources/upperEnemy.png"))).getImage();
        lowerEnemyImage = new ImageIcon(Objects.requireNonNull(getClass().getResource("../resources/lowerEnemy.png"))).getImage();
